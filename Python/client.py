...
def on_connect(client, userdata, flags, rc):
	...
	t = input('Insira o tópico no qual deseja inscrever-se: ') #t recebe uma string referente ao nome do tópico
	while True: 
		q = int(input('Defina o nível de QoS da inscrição [0-2]: ')) #q recebe o parâmetro de qos
...
def on_message(client, userdata, message):
	...
	print(f'payload: {message.payload.decode()}') #exibe a mensagem recebida em unicode
